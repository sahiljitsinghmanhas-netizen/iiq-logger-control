...
**[Watch the demo](docs/logger-manager-demo.mp4)** (2m 22s) - a screen recording
that opens the plugin from the IdentityIQ header, tours the settings, takes in the whole
page, turns a
...
trail. There is a [shorter cut](docs/logger-manager-demo-short.mp4) (1m 38s) with
...
| `Logger Manager` | An override managed here | on removal or expiry |
